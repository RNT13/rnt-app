...
const runOptions = () => __awaiter(void 0, void 0, void 0, function* () {
    // Perguntar sobre i18n
    const installI18n = yield askQuestion("Deseja instalar i18n? (y/n): ");
    ...
    const installOtherDeps = yield askQuestion("Deseja instalar a área de testes? (ex: Jest, Cypress, etc)? (y/n)");
